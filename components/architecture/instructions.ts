...
> = {
  ...
  call: {
    ...
    pipeline: [
      ...
      { step: "DECODE", lines: ["val = R[%rsp]", "valB = R[%rsp]"] },
  ...
  ret: {
    ...
    pipeline: [
      ...
      { step: "DECODE", lines: ["valA = R[%rsp]", "valB = R[%rsp]"] },
      { step: "EXECUTE", lines: ["valE = valB + 8"] },
      { step: "MEMORY", lines: ["valM = M8[valA]"] },
      { step: "WRITEBACK", lines: ["R[%rsp] = valE"] },
...
> = {
  ...
  // jmp
  jmp: {
    nodes: ["pc", "valC", "nextPC", "mem", "pc", "nextPC"],
    logicalWires: [
      { from: "pc", to: "icode" },
      { from: "valC", to: "nextPC" },
      { from: "nextPC", to: "pc" },
